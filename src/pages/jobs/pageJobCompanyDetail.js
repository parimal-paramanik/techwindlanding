                            ...
                            <div className="lg:-mt-[330px] -mt-[299px]">
                                <div className="rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                                    <div className="text-center py-8 p-6 border-b border-gray-100 dark:border-gray-700">
                                        <img src={data?.image ? data?.image : circle_logo} className="h-24 w-24 p-4 shadow-md mx-auto rounded-full block" alt="" />
                                    ...
                                    <div className="p-6">
                                        ...
                                        <ul className="list-none mt-4">
                                            <li className="flex mt-2 items-center font-medium"><Icon.MapPin className="h-4 w-4 text-amber-500 me-3"></Icon.MapPin><span className="text-slate-400 me-3">Location :</span> {data?.place ? data?.place : 'San Francisco'}</li>
                                            <li className="flex mt-2 items-center font-medium"><Icon.Link className="h-4 w-4 text-amber-500 me-3"></Icon.Link><span className="text-slate-400 me-3">Comapny :</span> {data?.company ? data?.company : 'circleci.com'}</li>
