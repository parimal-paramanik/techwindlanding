                            ...
                            <div className="relative overflow-hidden">
                                ...
                                <div className="absolute start-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                                    <div className="pb-4 ps-4 flex items-center">
                                        <img src={item.image2} className="h-12 w-12 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="" />
                                        <div className="ms-3">
                                ...
                                {communityData.map((item , index)=>{
                                    return(
                                        <div className="slide h-auto md:w-[360px] w-72 m-2" key={index}>
                                            ...
                                            <li className="rounded-lg shadow dark:shadow-gray-800 p-6">
                                                <div className="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                                    <img src={item.image2} className="h-16 w-16 rounded-full shadow dark:shadow-gray-800" alt="" />
                                        ...
                                        <div className="group text-center">
                                            <div className="relative inline-block mx-auto h-52 w-52 rounded-full overflow-hidden">
                                                ...
                                                <ul className="list-none  space-x-1 absolute start-0 end-0 -bottom-20 group-hover:bottom-5 transition-all duration-500 ease-in-out">
                                                    <li className="inline">
                                                        <Link to="" className="h-8 w-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border border-indigo-600 bg-indigo-600 hover:border-indigo-600 hover:bg-indigo-600 text-white">
