                                ...
                                {gymAbout.map((item,index)=>{
                                    return(
                                        <div className="group relative overflow-hidden p-6 rounded-lg shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 bg-white dark:bg-slate-900 text-center transition-all duration-500 ease-in-out border-t-8 border-indigo-600/50" key={index}>
                                            <img src={item.image1} className="w-16 h-16 mx-auto" alt="" />
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute bottom-16 end-0">
                                    ...
                                    <div className="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                                        <Link to="/#!" data-type="youtube" data-id="S_CGed6E610" className="lightbox h-14 w-14 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 dark:text-white">
                                ...
                                return (
                                    <div className="picture-item-gym p-2" data-groups={data.dataGroup} key={index}>
                                        <div className="text-center p-6 shadow dark:shadow-gray-800 rounded-md">
                                            <img src={data.image} className="h-16 w-16 mx-auto" alt="" />
                            ...
                            return(
                                ...
                                <div className="content absolute bottom-0 group-hover:bottom-6 start-0 end-0 transition-all duration-500 opacity-0 group-hover:opacity-100">
                                    ...
                                    <ul className="list-none relative -bottom-12 group-hover:bottom-0 transition-all duration-500 mt-4 flex justify-center space-x-1">
                                        <li><Link to="#" className="h-8 w-8 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center border text-white rounded-md border-indigo-600 bg-indigo-600"><Icon.Facebook className="h-4 w-4"></Icon.Facebook></Link></li>
                                        <li><Link to="#" className="h-8 w-8 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center border text-white rounded-md border-indigo-600 bg-indigo-600"><Icon.Instagram className="h-4 w-4"></Icon.Instagram></Link></li>
                                        <li><Link to="#" className="h-8 w-8 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center border text-white rounded-md border-indigo-600 bg-indigo-600"><Icon.Twitter className="h-4 w-4"></Icon.Twitter></Link></li>
                                        <li><Link to="#" className="h-8 w-8 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center border text-white rounded-md border-indigo-600 bg-indigo-600"><Icon.Linkedin className="h-4 w-4"></Icon.Linkedin></Link></li>
                                    </ul>
                                </div>
                            </div>
            ...
            <section className="py-20 w-full table relative bg-[url('../../assets/images/gym/cta.jpg')] bg-center bg-no-repeat bg-fixed bg-cover">
                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 text-center">
                        ...
                        <Link onClick={() => setOpen(true)} data-type="youtube" data-id="S_CGed6E610" className="lightbox h-20 w-20 rounded-full shadow-md dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 mx-auto mt-10">
