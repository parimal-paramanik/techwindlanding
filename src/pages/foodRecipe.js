                            ...
                            <div className="px-6 py-12 bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-gray-800 text-center">
                                ...
                                <div className="flex items-center justify-center mt-5">
                                    <div className="flex items-center mx-2">
                                        <img src={imageP} className="h-7 w-7 rounded-full shadow-md dark:shadow-gray-800" alt="" />
                        ...
                        <div className="lg:col-span-8 md:col-span-6">
                            ...
                            <div className="p-6 rounded-md shadow dark:shadow-gray-800 mt-8">
                                ...
                                <div className="mt-8">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center">
                                            <img src={image4} className="h-11 w-11 rounded-full shadow" alt="" />
                        ...
                        <div className="lg:col-span-4 md:col-span-6">
                            <div className="sticky top-20">
                                ...
                                <div className="text-center mt-8">
                                    <img src={imageP} className="h-24 w-24 mx-auto rounded-full shadow mb-4" alt="" />
