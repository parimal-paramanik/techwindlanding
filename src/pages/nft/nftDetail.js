                                            ...
                                            <div>
                                                <div className="grid grid-cols-1">
                                                    ...
                                                    <div className="flex items-center mt-3">
                                                        <img src={image} className="h-16 w-16 rounded-full shadow-md dark:shadow-gray-800" alt="" />
                                                ...
                                                <div className="grid grid-cols-1">
                                                    <div className="flex items-center">
                                                        <div className="relative">
                                                            <img src={image1} className="h-16 w-16 rounded-full shadow-md dark:shadow-gray-800" alt="" />
                                                        </div>
                                                    ...
                                                    <div className="flex items-center mt-4">
                                                        <div className="relative">
                                                            <img src={image2} className="h-16 w-16 rounded-full shadow-md dark:shadow-gray-800" alt="" />
                                                        </div>
                                                    ...
                                                    <div className="flex items-center mt-4">
                                                        <div className="relative">
                                                            <img src={image3} className="h-16 w-16 rounded-full shadow-md dark:shadow-gray-800" alt="" />
                                                        </div>
                                            ...
                                            <div>
                                                <div className="grid grid-cols-1">
                                                    <div className="rounded-md shadow dark:shadow-gray-800 p-6">
                                                        <div className="flex items-center">
                                                            <div className="relative">
                                                                <img src={image4} className="h-20 w-20 rounded-md shadow-md dark:shadow-gray-800" alt="" />
