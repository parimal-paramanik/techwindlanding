                                ...
                                <div className="px-6">
                                    <ul>
                                        <li className="flex justify-between items-center py-6">
                                            ...
                                            <div>
                                                <Link className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center bg-red-600/5 hover:bg-red-600 border-red-600/10 hover:border-red-600 text-red-600 hover:text-white rounded-full"><Icon.Trash2 className="h-4 w-4"></Icon.Trash2></Link>
                                            </div>
                                        </li>
