    ...
    return (
        <>
            ...
            <section className="relative flex md:h-screen  py-44 items-center bg-cover bg-center self-center">
                <div className="absolute inset-0 h-full w-full  bg-fixed"  style={{ background: `url(${background}) bottom` }}></div>
                <div className="absolute inset-0 h-full w-full md:block hidden jarallax bg-fixed"  style={{ background: `url(${textLg}) center` }}></div>
                <div className="absolute inset-0 h-full w-full block md:hidden jarallax" data-jarallax data-speed="0.5" style={{ background:`url(${textSm}) center` }}></div>
                <div className="absolute inset-0 h-full w-full jarallax" data-jarallax data-speed="1.1" style={{ background: `url(${presonImage}) bottom` }}></div>
                            ...
                            <div key={index} className="p-1 picture-item" >
                                 <div className="group relative block overflow-hidden rounded-md transition-all duration-500">
                                    ...
                                    <div className="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center opacity-0 group-hover:opacity-100 duration-500">
                                        <Link onClick={()=>handleImageClick(index)} className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white lightbox"><FiCamera className='w-4 h-4'/></Link>
                                    </div>
                                </div>
                            </div>
                                 )
