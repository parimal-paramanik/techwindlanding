                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                        ...
                        <div className="lg:col-span-7 md:col-span-6 order-2 md:order-1">
                            <div className="lg:me-5">
                                ...
                                <div className="mt-6">
                                    <Link to="#" onClick={() => setOpen(true)} className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white lightbox"><Icon.Video className="h-4 w-4"></Icon.Video></Link><span className="font-semibold ms-2 align-middle">Watch Now</span>
                                </div>
