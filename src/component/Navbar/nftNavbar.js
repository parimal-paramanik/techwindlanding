            ...
            <div className="container relative">
                ...
                <ul className="buy-button list-none space-x-1 mb-0">
                    ...
                    <li className="inline-block ps-1 mb-0">
                        <Link id="connectWallet" onClick={metamask}  className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white"><BiWallet/></Link>
                    </li>
                    ...
                    <li className="dropdown inline-block relative ps-1">
                        ...
                        <div className= {`dropdown-menu absolute end-0 m-0 mt-4 z-10 w-48 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow dark:shadow-gray-800  ${isDropdown ? 'hidden' : 'block'}`}>
                            ...
                            <ul className="py-2 text-start">
                                ...
                                <li>
                                    <Link to="/auth-login" className="flex items-center text-[14px] font-semibold py-1.5 px-4 hover:text-indigo-600"><LiaSignOutAltSolid className="me-2 h-4 w-4"/> Logout</Link>
                                </li>
                            </ul>
                        </div>
                    </li>
