                        ...
                        <ul className="submenu megamenu">
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "index-ai" || "" ? "active" : ""}><Link to="/index-ai" className="sub-menu-item">AI Tools</Link></li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "index-christmas" || "" ? "active" : ""}><Link to="/index-christmas" className="sub-menu-item">Christmas <span className="bg-yellow-500 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></Link></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "index-classic-business" || "" ? "active" : ""}><Link to="/index-classic-business" className="sub-menu-item">Classic Business <span className="bg-yellow-500 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></Link></li>
