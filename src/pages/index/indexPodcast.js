                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center mt-10 gap-[30px]">
                    ...
                    <div className="lg:col-span-5 relative">
                        ...
                        <div className="absolute -top-4 start-1/2 -translate-x-1/2 text-center">
                            <Link to="#!" onClick={() => setOpen(true)}  className="lightbox h-20 w-20 rounded-full shadow-md dark:shadow-gyay-700 inline-flex items-center justify-center text-white bg-indigo-600">
                                ...
                                <div className="tiny-slide" key={index}>
                                    <div className="group relative rounded-md shadow dark:shadow-gray-800 overflow-hidden m-3">
                                        <div className="relative">
                                            ...
                                            <Link to="#!" onClick={() => setOpen(true)} className="lightbox h-8 w-8 inline-flex items-center justify-center rounded-full bg-white border border-white text-indigo-600 absolute top-3 end-3"><i className="mdi mdi-play"></i></Link>
                                            ...
                                            <div className="absolute start-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                                                <div className="pb-4 ps-4 flex items-center">
                                                    <img src={clientImage} className="h-10 w-10 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt=""/>
                                                    <div className="ms-3">
